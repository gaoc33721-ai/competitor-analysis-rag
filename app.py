        ...
        with st.spinner("🔍 正在检索素材库并生成策略分析..."):
            try:
                ...
                prompt = PromptTemplate(
                    ...
                    8. **绝对聚焦素材表现而非产品性能**：在介绍推荐亮点时，**严禁**像产品说明书一样复述产品的物理性能（如“容量大”、“制冷快”、“省电”）。你必须**100%聚焦于该素材在视觉呈现、版式设计和电商文案技巧上的优点**（例如：“主图通过水花飞溅的视觉效果直观展示了清洗力度”、“文案采用了‘一台顶三台’的场景化对比手法，极大降低了用户的决策成本”等），向业务人员解释这张“图/文”为什么在营销上做得好、值得借鉴。
